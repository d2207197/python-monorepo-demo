...
@main.command()
@click.option("--target-folder", "-t", required=False, type=str, help="Target folder for HDFS data")
...
@main.command()
@click.option("--source-data-folder", "-s", required=False, type=str, help="Source folder for raw data")
@click.option("--dataset-target-folder", "-t", required=False, type=str, help="Target folder for processed dataset")
...
@main.command()
@click.option("--dataset", "-d", required=False, type=str, help="Dataset to be used for training the matching model")
